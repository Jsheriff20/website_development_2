				...
				<div class="row">
					...
					<div class="col-lg-12 text-center">
						...
						<div class="row" style="padding-bottom:50px; margin-left: 10%; margin-right: 10%;">
							...
							<div class="col">
								<h3> Wrote by author '<?php get_article_details("About Golden State Warriors", "articles_author") ?>' </h3>
								...
								<form name="add_comment" id="add_comment" action="add_comment.php" onsubmit="return validate_comment()" method="post">
									<table class="table">
										<tbody>
											...
											<input type='hidden' name='articles_title' value='<?php get_article_details("About Golden State Warriors", "articles_title")?>'/>
