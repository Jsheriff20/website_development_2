...
<html lang="en">
		<head>
			<title color="white"><?php get_article_details("About Miami Heat", "articles_title") ?></title>
			...
			<header class="banner navbar-fixed-top">
				...
				<h3> <?php get_article_details("About Miami Heat", "articles_title") ?> </h3>
			</header>
					...
					<div class="col-lg-12 ">
						...
						<div class="row text-center" style="padding-bottom:50px; margin-left: 10%; margin-right: 10%;">
							...
							<div class="col">
								...
								<h1> <?php get_article_details("About Miami Heat", "articles_title") ?> <h1>


							<div id="carouselExampleSlidesOnly" class="carousel slide" data-ride="carousel">
								<div class="carousel-inner">

									<?php get_article_images("About Miami Heat");?>
								</div>
							</div>
						...
						<div class="row" style=" margin-left: 10%; margin-right: 10%;">	
							...
							<div class="col">
								...
								<?php get_article_details("About Miami Heat", "articles_text") ?>
							</div>
						</div>
						...
						<div class="row" style="padding-bottom:50px; margin-left: 10%; margin-right: 10%;">
							...
							<div class="col">
								<h3> Written by author '<?php get_article_details("About Miami Heat", "articles_author") ?>' </h3>
						...
						<div class="row text-center" style="margin-left: 10%; margin-right: 10%;">
							...
							<h2> <?php get_amount_of_comments("About Miami Heat")?> </h2>
								...
								<form name="add_comment" id="add_comment" action="add_comment.php" onsubmit="return validate_comment()" method="post">
									<table class="table">
										<tbody>
											...
											<input type='hidden' name='articles_title' value='<?php get_article_details("About Miami Heat", "articles_title")?>'/>
						...
						<div class="row" style="padding-bottom:10px; margin-left: 10%; margin-right: 10%;">	
							...
							<?php get_article_comments("About Miami Heat")?>
						</div>
					</div>
				</div>
			</main>
